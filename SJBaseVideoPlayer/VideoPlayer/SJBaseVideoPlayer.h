...
@property (nonatomic, copy, readwrite, nullable) void(^rateChanged)(SJBaseVideoPlayer *player);

- (void)resetRate;

@property (nonatomic, copy, readwrite, nullable) void(^playDidToEnd)(SJBaseVideoPlayer *player); // 播放完毕
...
@property (nonatomic, copy, readwrite, nullable) void(^willRotateScreen)(SJBaseVideoPlayer *player, BOOL isFullScreen); // 将要旋转的时候调用

@property (nonatomic, copy, readwrite, nullable) void(^rotatedScreen)(SJBaseVideoPlayer *player, BOOL isFullScreen);    // 已旋转
...
@property (nonatomic, copy, readwrite, nullable) void(^presentationSize)(SJBaseVideoPlayer *videoPlayer, CGSize size);
